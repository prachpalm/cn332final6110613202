public class KingSizeBed implements Room {
   private double totalPrice = 2000;
   ...
   @Override
   public void book() {
      System.out.println("Booked. Room type: King Size Bed");
   }
   
   @Override
   public double getPrice() {
       //System.out.println("King Size Bed Price: " + price);
       return totalPrice;
   }
